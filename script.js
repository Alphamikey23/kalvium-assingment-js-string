...
var lenght_string = myString.length;
// Challenge 4: Store a string in a variable and convert it into uppercase.
var myString_upper = myString.toUpperCase;
...
var myString2 = "I love programming";
var result = myString.replace("programming","JavaScript programming")
console.log(myString2)
// Challenge 6: Store a string in variable and print the string in console 3 times using repeat method.
var myString3 = "This is a string";
var result1 = myString3.repeat(3)
...
var myString3 = "I am a Kalvian";
const result2 = myString3.split()
console.log(result2)
...
var myString4 = "Time and Tide wait for none"
var result3 = myString4.indexOf("Ti")
console.log(result3)
...
var myString5 = "When life gives you lemons make lemonade"
var result4 = myString5.search("lemon")
console.log(result4)
...
var myString6 = "You must be the change you wish to see in the world"
console.log(myString6.substring(16,22))
console.log(myString6.substring(46,52))
